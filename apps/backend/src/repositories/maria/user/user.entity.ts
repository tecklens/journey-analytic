...
import {IFailedLogin, IUser, IUserResetTokenCount, UserId, UserStatus} from "@journey-analysis/stateless";
...
export class UserEntity implements IUser {
  ...
  @Column({ name: 'num_day_delete_video', type: 'smallint', default: 25 })
